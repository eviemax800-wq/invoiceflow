...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const blogSlugs = ['how-to-create-tax-invoice-australia', 'gst-guide-australian-freelancers', 'freelance-rates-australia', 'invoicing-international-clients-australia', 'best-invoicing-software-australia', 'sole-trader-vs-company-australia'];
