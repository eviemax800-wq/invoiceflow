...
export const metadata: Metadata = {
  title: 'Invoicing Software Adelaide — Invoice App for Adelaide Freelancers & Small Business | InvoiceFlow',
  description:
    'Simple invoicing software for Adelaide freelancers, sole traders and small businesses. GST-compliant invoices, BAS-ready exports, and 100+ free tools. Built for SA businesses — from the Barossa to Glenelg. Starts free.',
  alternates: { canonical: '/in/adelaide' },
  openGraph: {
    title: 'InvoiceFlow Adelaide — Invoicing Built for SA Freelancers',
    description:
      'Adelaide freelancers and sole traders: stop overpaying for Xero. InvoiceFlow handles invoicing, GST, and BAS exports — starting free. Built for the festival city.',
  },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'Adelaide', item: 'https://invoiceflow-teal.vercel.app/in/adelaide' },
  ],
};
...
const faqSchema = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'What invoicing software do Adelaide freelancers use?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Many Adelaide freelancers are switching from Xero ($35/mo) and MYOB ($36/mo) to InvoiceFlow. It offers GST-compliant invoicing, BAS-ready exports, and 100+ free business tools starting from $0/month. With Adelaide\'s lower cost of living, keeping software costs down means more profit in your pocket.',
      },
    },
    {
      '@type': 'Question',
      name: 'Does InvoiceFlow handle GST for South Australian businesses?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes. InvoiceFlow automatically calculates 10% GST on every invoice, tracks your $75,000 registration threshold, and generates BAS-ready reports. Whether you\'re a wine tour operator in the Barossa or a graphic designer in Norwood, GST compliance is handled automatically.',
      },
    },
    {
      '@type': 'Question',
      name: 'Is InvoiceFlow free for Adelaide sole traders?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'InvoiceFlow offers a free forever tier with 5 invoices per month, Gmail sync, CSV export, and access to 100+ free business tools. The Pro plan is $19/month — less than half the cost of Xero. That\'s money better spent at the Central Market.',
      },
    },
    {
      '@type': 'Question',
      name: 'Can Adelaide event and festival businesses use InvoiceFlow?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Absolutely. Adelaide\'s thriving events scene — from Adelaide Fringe to WOMADelaide to the Tour Down Under — means thousands of freelancers need fast invoicing for short-turnaround gigs. InvoiceFlow lets you create and send professional invoices in under 30 seconds, perfect for festival season.',
      },
    },
    {
      '@type': 'Question',
      name: 'How does InvoiceFlow compare to Xero for Adelaide small businesses?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Xero costs $35/month ($420/year) and is built for businesses that need full accounting suites. Most Adelaide freelancers and sole traders only need invoicing and GST tracking. InvoiceFlow starts free and the Pro plan is $19/month ($228/year) — saving you $192/year. That adds up fast when Adelaide\'s affordability is your competitive advantage.',
      },
    },
  ],
};
...
const painPoints = [
  {
    ...
    solution: 'InvoiceFlow starts free. Pro is $19/mo — half the cost of Xero. Adelaide&apos;s affordability advantage starts with your tools.',
    icon: (
  ...
  {
    problem: 'Festival season hits and you&apos;re buried in manual invoicing',
    solution: 'Create professional invoices in 30 seconds. Batch send after Fringe or WOMADelaide gigs.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  {
    problem: 'Chasing late payments with awkward follow-up emails',
...
export default function InAdelaidePage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-white">
      ...
      <section className="mx-auto max-w-6xl px-6 pt-20 pb-16 text-center">
        <div className="inline-block rounded-full border border-rose-500/30 bg-rose-500/10 px-4 py-1.5 text-sm font-medium text-rose-400 mb-8">
          Built for Adelaide Businesses
        </div>
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight mb-6">
          Invoicing software{' '}
          <span className="bg-gradient-to-r from-rose-400 to-pink-400 bg-clip-text text-transparent">
            Adelaide freelancers
          </span>{' '}
          actually love
        </h1>
        <p className="mx-auto max-w-2xl text-lg text-slate-400 mb-10">
          From the Barossa to Glenelg, Adelaide&apos;s freelancers and small businesses deserve invoicing that&apos;s
          as affordable as the city itself. GST-compliant, BAS-ready, and built for the way SA works.
        </p>
      ...
      <section className="mx-auto max-w-6xl px-6 pb-16">
        <div className="flex flex-wrap justify-center gap-3">
          {['Wine & Food', 'Festivals & Events', 'Defence & Space', 'Health & Medical', 'Education', 'Manufacturing', 'Creative Arts', 'Construction & Trades'].map((industry) => (
            <span key={industry} className="rounded-full border border-rose-500/20 bg-rose-500/5 px-4 py-1.5 text-sm text-rose-300">
              {industry}
            </span>
          ))}
        </div>
      ...
      <section className="mx-auto max-w-6xl px-6 py-16">
        <h2 className="text-3xl font-bold text-center mb-4">
          Adelaide invoicing shouldn&apos;t cost more than your coffee
        </h2>
        <p className="text-center text-slate-400 mb-12 max-w-2xl mx-auto">
          Adelaide&apos;s lower cost of living is your superpower. Don&apos;t waste it on bloated accounting software built for corporates.
        </p>
      ...
      <section className="mx-auto max-w-6xl px-6 py-16">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            { stat: '120K+', label: 'SA sole traders' },
      ...
      <section className="mx-auto max-w-6xl px-6 py-16">
        <h2 className="text-3xl font-bold text-center mb-4">
          How InvoiceFlow compares for Adelaide businesses
        </h2>
        <p className="text-center text-slate-400 mb-10 max-w-2xl mx-auto">
          You don&apos;t need a full accounting suite to invoice clients after a Fringe gig or a cellar door consulting job.
        </p>
          ...
          <table className="w-full text-left text-sm">
            ...
            <tbody className="text-slate-300">
              ...
              <tr className="border-b border-white/5">
                ...
                <td className="py-3 px-4 text-rose-400">Included</td>
              ...
              <tr className="border-b border-white/5">
                ...
                <td className="py-3 px-4 text-rose-400">30 seconds</td>
      ...
      <section className="mx-auto max-w-6xl px-6 py-16">
        ...
        <p className="text-center text-slate-400 mb-10">
          Purpose-built invoicing guides for every type of Adelaide business.
        </p>
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {[
            ...
            { title: 'For Contractors', href: '/for/contractors', desc: 'Subcontractors and project workers' },
            { title: 'For Tradies', href: '/for/tradies', desc: 'Electricians, plumbers, builders' },
            { title: 'For Consultants', href: '/for/consultants', desc: 'Business and strategy advisors' },
            { title: 'For Creatives', href: '/for/creatives', desc: 'Photographers, artists, videographers' },
          ].map((persona) => (
            <Link
              key={persona.href}
              href={persona.href}
      ...
      <section className="mx-auto max-w-6xl px-6 py-16">
        <h2 className="text-3xl font-bold text-center mb-4">
          Free tools for Adelaide businesses
        </h2>
        <p className="text-center text-slate-400 mb-10">
      ...
      <section className="mx-auto max-w-3xl px-6 py-16">
        <h2 className="text-3xl font-bold text-center mb-10">
          Common questions from Adelaide businesses
        </h2>
      ...
      <section className="mx-auto max-w-4xl px-6 py-20 text-center">
        <h2 className="text-3xl sm:text-4xl font-bold mb-4">
          Join Adelaide freelancers who invoice smarter
        </h2>
        <p className="text-slate-400 mb-8 max-w-xl mx-auto">
          Whether you&apos;re in North Adelaide, Glenelg, Norwood, or Unley — InvoiceFlow helps you get paid faster
